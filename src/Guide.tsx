...
export default function Guide({children}: {children?: ReactNode}) {
  ...
  return <main className="guide-page">
    ...
    <article className="guide-content">
      ...
      <section><h2>玩法</h2><p>手机按住游戏画面，电脑按住鼠标或空格蓄力，松开起跳。按得越久，跳得越远。观察小人的压缩与小岛上的聚能效果，瞄准下一座岛的黄色圆心。</p><p>右上角的 ☰ 菜单可以暂停、控制声音和设置成绩弹窗。打开本说明会暂停当前对局；返回后点击“继续游戏”接着玩。</p></section>
      ...
      <section><h2>成绩提示</h2><p>结算时可勾选“以后不再显示此弹窗”。下次结束仅显示简洁成绩和重开按钮，不会自动上传。仍可点击“提交成绩”手动上榜，也可在菜单中恢复自动弹窗。</p></section>
